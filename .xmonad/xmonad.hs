...
myWorkspaces = [" dev ", " www ", " anki ", " doc ", " vbox ", " chat ", " mus ", " vid ", " gfx "]
...
myManageHook = composeAll
     ...
     , className =? "Anki"            --> doShift ( myWorkspaces !! 2 )
...
myKeys =
    ...
    -- KB_GROUP Get Help
        , ("M-M1-k", spawn "~/.xmonad/xmonad_keys.sh") -- Get list of keybindings
        , ("M-/", spawn "dtos-help")                  -- DTOS help/tutorial videos

    -- KB_GROUP Run Prompt
        --, ("M-S-<Return>", spawn "dmenu_run -i -p \"Run: \"") -- Dmenu
        , ("M-S-<Return>", spawn "rofi -show combi -modi combi") -- Rofi
    ...
    -- KB_GROUP Useful programs to have a keybinding for launch
        ...
        , ("M-b", spawn (myBrowser))
        , ("M-S-l", spawn "i3lock -i ~/Desktop/tt.png")
    ...
    -- Toggle them to hide and it sends them back to hidden workspace (NSP).
        ...
        , ("M1-<Return>", namedScratchpadAction myScratchPads "mocp")
        , ("M-M1-c", namedScratchpadAction myScratchPads "calculator")
